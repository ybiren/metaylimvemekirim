...
@Component({
  ...
  template: `
    <div class="wrap" dir="rtl" [class.mobile]="data.isMobile">
      ...
      <h3 class="title">שיתוף פרופיל</h3>
  ...
  styles: [`
    ...
    .btns{ display:grid; gap:10px; margin:12px 0; }
    .btn{
      border:0; border-radius:12px; padding:12px 12px; cursor:pointer;
    ...
    .cancel{
      ...
      padding:10px 20px; cursor:pointer; font-weight:800;
    }
