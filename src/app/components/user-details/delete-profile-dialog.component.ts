...
export type DeleteProfileResult = 'yes' | 'no';
...
@Component({
  ...
  template: `
    <div class="wrap" dir="rtl">
      <h3 class="title">האם אתה בטוח שברצונך למחוק את הפרופיל?</h3>
...
export class DeleteProfileDialogComponent {
  private dialogRef = inject<DialogRef<DeleteProfileResult>>(DialogRef);

  close(result: DeleteProfileResult) {
